...
// @Animation
Animation* ANIMATION_ARCHER_ATTACK = nullptr;
...
const Name* PATH_ANIMATION_ARCHER_RELOAD = nullptr;
const Name* PATH_ANIMATION_ARCHER_IDLE = nullptr;
const Name* PATH_MESH_ICON_STATE_ATTACK = nullptr;
...
bool LoadAssets(Allocator* allocator)
{
    ...
    PATH_ANIMATION_ARCHER_RELOAD = GetName("archer_reload");
    PATH_ANIMATION_ARCHER_IDLE = GetName("archer_idle");
    PATH_MESH_ICON_STATE_ATTACK = GetName("icon_state_attack");
    ...
    // @Animation
    NOZ_LOAD_ANIMATION(allocator, PATH_ANIMATION_ARCHER_ATTACK, ANIMATION_ARCHER_ATTACK);
...
void HotloadAsset(const Name* incoming_name, AssetType incoming_type)
{
    ...
    // @Animation
    NOZ_RELOAD_ANIMATION(PATH_ANIMATION_ARCHER_ATTACK, ANIMATION_ARCHER_ATTACK);
